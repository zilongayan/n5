...
# 🚀 Déploiement Vercel MangaView - Version Minimal
# Usage: ./deploy-vercel-minimal.sh

set -e

echo "🚀 Déploiement Vercel MangaView - Version Minimal"
echo "================================================="
...
# Remplacement par les versions simplifiées
echo -e "${BLUE}📦 Utilisation des versions simplifiées...${NC}"
...
echo ""
echo -e "${YELLOW}⚠️  Note : Cette version minimal n'inclut pas Tailwind CSS${NC}"
