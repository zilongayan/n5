...
export function GalleryContent({item, related}: GalleryContentProps) {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-surface-elevated rounded-lg p-4 text-center hover-card transition-colors">
                ...
                <div className="text-sm text-muted">{t('gallery.stats.pages')}</div>
              </div>
              <div className="bg-surface-elevated rounded-lg p-4 text-center hover-card transition-colors">
                <div className="text-2xl font-bold text-primary">4.8</div>
                <div className="text-sm text-muted">{t('gallery.stats.rating')}</div>
              </div>
              <div className="bg-surface-elevated rounded-lg p-4 text-center hover-card transition-colors">
                <div className="text-2xl font-bold text-primary">1.2K</div>
                <div className="text-sm text-muted">{t('gallery.stats.views')}</div>
              </div>
              <div className="bg-surface-elevated rounded-lg p-4 text-center hover-card transition-colors">
                <div className="text-2xl font-bold text-primary">89</div>
                <div className="text-sm text-muted">{t('gallery.stats.favorites')}</div>
              </div>
            </div>
      ...
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border border-gray-200 dark:border-gray-700 rounded-2xl p-8">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">{t('gallery.preview')}</h2>
