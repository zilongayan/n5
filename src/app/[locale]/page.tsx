        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-2/3">
              <a href={`/${locale}/gallery/${popularMangas[0]?.id}`} className="block">
                    ...
                    <div className="lg:w-1/2 p-8 flex flex-col justify-center">
                      <div className="mb-6">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {popularMangas[0]?.tags?.slice(0, 3).map((tag: string, tagIndex: number) => (
                            <span 
                              key={tagIndex}
                        ...
                        <p className="text-gray-400 text-lg line-clamp-3">
                          {popularMangas[0]?.description || 'Description non disponible'}
                        </p>
                      </div>
            ...
            <div className="lg:w-1/3">
              <div className="space-y-4">
                {popularMangas.slice(1, 4).map((manga, index) => (
