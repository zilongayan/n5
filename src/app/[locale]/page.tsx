...
import HorizontalMangaCard from '@/components/HorizontalMangaCard';
import { getCatalogPage, CatalogItem } from '@/data/catalog';
    ...
    <div className="min-h-screen bg-[#0B0C0F]">
      ...
      <section className="relative overflow-hidden py-20 bg-gradient-to-br from-[#151821]/80 via-[#151821]/60 to-[#151821]/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Découvrez des milliers de mangas en streaming gratuit
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto mb-8">
            <div className="text-center">
              ...
              <div className="text-gray-400 text-sm">Titres disponibles</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-pink-400 mb-1">∞</div>
              <div className="text-gray-400 text-sm">Chapitres</div>
            </div>
            <div className="text-center">
          ...
          <div className="max-w-2xl mx-auto">
            <SearchBar placeholder="Rechercher un manga..." />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-2/3">
              <FeaturedMangaCard
                manga={{
                  id: popularMangas[0]?.id || '',
                  title: popularMangas[0]?.title || '',
                  cover: popularMangas[0]?.cover || '',
                  description: popularMangas[0]?.description || 'Description non disponible',
                  tags: popularMangas[0]?.tags || [],
                  rating: 4.8,
                  views: 1250000,
                  chapters: 156,
            ...
            <div className="lg:w-1/3">
              <div className="space-y-4">
                {popularMangas.slice(1, 4).map((manga: CatalogItem, index: number) => (
                  <HorizontalMangaCard
                    key={manga.id}
                    manga={{
                      id: manga.id,
                      title: manga.title,
                      cover: manga.cover,
                      description: manga.description || 'Description non disponible',
                      tags: manga.tags || [],
                      rating: 4.5 + (Math.random() * 0.5),
                      views: Math.floor(Math.random() * 500000) + 100000,
                      chapters: Math.floor(Math.random() * 100) + 20,
      ...
      <div className="py-16 bg-slate-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              🗂️ <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                Parcourir par Catégorie
              </span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Explorez nos collections organisées par thèmes et genres
            </p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {['Action', 'Romance', 'Fantasy', 'Comedy', 'Drama', 'Horror', 'Sci-Fi', 'Slice of Life'].map((category) => (
              <a
                key={category}
                href={`/${locale}/tags/${category.toLowerCase()}`}
                className="group bg-gradient-to-br from-slate-800/60 to-slate-700/60 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 hover:border-purple-500/40 transition-all duration-500 hover:bg-slate-700/60 hover:shadow-xl hover:shadow-purple-500/10 transform hover:-translate-y-2"
              >
                <div className="text-center">
