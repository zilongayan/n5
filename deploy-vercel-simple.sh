...
# 🚀 Déploiement Vercel MangaView - Version Simplifiée
# Usage: ./deploy-vercel-simple.sh

set -e

echo "🚀 Déploiement Vercel MangaView - Version Simplifiée"
echo "===================================================="
...
# Remplacement par le package.json simplifié
echo -e "${BLUE}📦 Utilisation du package.json simplifié...${NC}"
cp package-simple.json package.json

# Installation des dépendances simplifiées
echo -e "${BLUE}📦 Installation des dépendances simplifiées...${NC}"
...
echo ""
echo -e "${YELLOW}⚠️  Note : Cette version simplifiée n'inclut pas Tailwind CSS${NC}"
echo -e "${YELLOW}   Vous pourrez l'ajouter après le déploiement initial réussi${NC}"
